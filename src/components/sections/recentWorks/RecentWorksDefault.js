        ...
        <div className="row grid-items border-line-v">
          ...
          <div className="col col-d-6 col-t-6 col-m-12 grid-item photo border-line-h">
            <div className="box-item">
              <div className="image">
                <a href="images/work-image1.png" className="has-popup-image">
                  <img src="images/work-image1.png" alt="" />
                  <span className="info">
          ...
          {/* work item video */}
            ...
            <div className="box-item">
              <div className="image">
                <a href="images/work-image2.png" className="has-popup-image">
                  <img src="images/work-image2.png" alt="" />
                  <span className="info">
                    <span className="ion ion-image" />
                  </span>
                </a>
              ...
              <div className="desc">
                <a
                  href="images/work-image2.png"
                  className="name has-popup-image"
                >
             Videograph-template created by ali ahmad
                </a>
          ...
          <div className="col col-d-6 col-t-6 col-m-12 grid-item music border-line-h">
            <div className="box-item">
              <div className="image">
                <a
                  href="https://reachaliahmad.github.io/Assignment-5-by-AS/"
                  className="has-popup-music"
                >
                  <img src="images/work-image3.png" alt="" />
                  <span className="info">
              ...
              <div className="desc">
                <a href="#" className="name has-popup">
                  Academia Template created by ali ahmad 
                </a>
                <div className="category">website</div>
              </div>
            </div>
